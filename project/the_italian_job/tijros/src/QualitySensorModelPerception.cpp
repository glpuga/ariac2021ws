...
void QualityControlSensorModelPerception::cameraCallback(
  ...
  for (const auto &ros_model : msg->models) {
    ...
    const auto relative_core_pose =
        tijcore::RelativePose3{quality_sensor_name_ + "_frame",
