...
Quaternion Rotation::quaternion() const { return quaternion_; }
...
Matrix3 Rotation::rotationMatrix() const {
  ...
  return Matrix3{Vector3{a11, a12, a13}, Vector3{a21, a22, a23},
                 Vector3{a31, a32, a33}};
}

Rotation Rotation::fromQuaternion(const double x, const double y,
                                  const double z, const double w) {
  return Rotation(Quaternion(x, y, z, w));
}

Rotation Rotation::fromRollPitchYaw(const double roll, const double pitch,
                                    const double yaw) {
...
bool Rotation::sameRotation(const Rotation &lhs, const Rotation &rhs,
