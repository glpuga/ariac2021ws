...
Matrix3 Matrix3::trans() const { return Matrix3{col(0), col(1), col(2)}; }
...
Matrix3 Matrix3::inv() const {
  ...
  return Matrix3(Vector3{b11, b12, b13}, Vector3{b21, b22, b23},
                 Vector3{b31, b32, b33})
             .trans() *
         (1.0 / this->det());
}

Vector3 &Matrix3::operator[](const size_t row_n) { return rows_[row_n]; }
...
Matrix3 &Matrix3::operator*=(const Matrix3 &rhs) {
  ...
  *this = Matrix3(Vector3{b11, b12, b13}, Vector3{b21, b22, b23},
                  Vector3{b31, b32, b33});
  return *this;
}
...
Matrix3 operator*(const double lhs, const Matrix3 &rhs) { return rhs * lhs; }
