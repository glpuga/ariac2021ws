...
ModelContainerInterface::ModelContainerInterface(
    const std::string &name, const std::string &container_reference_frame_id,
    const std::string &surface_reference_frame_id, const RelativePose3 &pose,
    const CuboidVolume &container_volume,
    const std::string &shared_workspace_id)
    : name_{name}, container_reference_frame_id_{container_reference_frame_id},
      surface_reference_frame_id_{surface_reference_frame_id}, pose_{pose},
