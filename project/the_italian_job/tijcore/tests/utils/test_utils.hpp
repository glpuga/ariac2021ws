...
inline bool areEqualWithinTolerance(const Vector3 &v1, const Vector3 &v2,
...
inline bool areEqualWithinTolerance(const Matrix3 &m1, const Matrix3 &m2,
                                    const double tolerance) {
...
inline bool areEqualWithinTolerance(const Isometry t1, const Isometry &t2,
                                    const double tolerance) {
