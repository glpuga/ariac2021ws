...
{
  auto within_tolerance = [tolerance](const double a, const double b) { return std::abs(a - b) < tolerance; };
  return within_tolerance(v1[0], v2[0]) && within_tolerance(v1[1], v2[1]) && within_tolerance(v1[2], v2[2]);
}
