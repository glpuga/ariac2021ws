...
TEST_F(WorkRegionIdTests, TestFromString) {
  ASSERT_EQ(WorkRegionId::kitting_near_bins,
            work_region::fromString("kitting_near_bins"));
  ASSERT_EQ(WorkRegionId::kitting_far_bins,
            work_region::fromString("kitting_far_bins"));
  ASSERT_EQ(WorkRegionId::kitting_agvs,
            work_region::fromString("kitting_agvs"));
...
TEST_F(WorkRegionIdTests, TestToString) {
  ASSERT_EQ("kitting_near_bins",
            work_region::toString(WorkRegionId::kitting_near_bins));
  ASSERT_EQ("kitting_far_bins",
            work_region::toString(WorkRegionId::kitting_far_bins));
