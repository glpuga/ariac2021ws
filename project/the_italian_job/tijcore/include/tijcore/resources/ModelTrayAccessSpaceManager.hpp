...
public:
  ...
  bool getAccessToModel(const std::string& target_parent, std::chrono::milliseconds timeout)
  {
...
private:
  ...
  bool getAccessToModelImpl(const std::string& first_target_parent,
                            ...
                            std::chrono::milliseconds timeout)
  {
    ...
    auto model_tray_access_space_descriptors = resource_manager_.getListOfExclusionZones();
