...
namespace tijcore
{
class ContactPartFromAboveAndGraspNode : public BT::AsyncActionNode
{
public:
  ContactPartFromAboveAndGraspNode(const std::string& name, const BT::NodeConfiguration& config,
  ...
  BT::NodeStatus tick() override
  {
    ...
    const auto retval = adapter_->contactPartFromAboveAndGrasp(target_pose);
