...
namespace tijcore
{
class CalculateSensorPreInsertAndInsertPosesNode : public BT::SyncActionNode
{
public:
  CalculateSensorPreInsertAndInsertPosesNode(const std::string& name,
  ...
  BT::NodeStatus tick() override
  {
    ...
    pre_insert_pose.position().vector().x() += 0.07;
    ...
    gripper_exit_pose.position().vector().x() += 0.25;
