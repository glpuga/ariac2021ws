...
#include <tijcore/logger/spdlog/pattern_formatter.h>
#endif

#include <tijcore/logger/spdlog/details/fmt_helper.h>
#include <tijcore/logger/spdlog/details/log_msg.h>
#include <tijcore/logger/spdlog/details/os.h>
#include <tijcore/logger/spdlog/fmt/fmt.h>
#include <tijcore/logger/spdlog/formatter.h>
...
// Full weekday name
static std::array<const char*, 7> full_days{ { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday",
                                               "Saturday" } };
...
// Abbreviated month
static const std::array<const char*, 12> months{ { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sept",
                                                   "Oct", "Nov", "Dec" } };
