...
#include <tijcore/logger/spdlog/details/backtracer.h>
...
public:
  ...
  template <typename FormatString, typename std::enable_if<fmt::is_compile_string<FormatString>::value, int>::type = 0,
            typename... Args>
  ...
  // T can be statically converted to string_view and isn't a
  // fmt::compile_string
