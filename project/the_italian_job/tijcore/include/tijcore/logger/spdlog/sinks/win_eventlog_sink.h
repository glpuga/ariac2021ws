...
#include <tijcore/logger/spdlog/details/windows_include.h>
#include <winbase.h>
...
public:
  ...
  static sid_t get_current_user_sid()
  {
    ...
    } current_process_token(::GetCurrentProcess());  // GetCurrentProcess returns pseudohandle, no
                                                     // leak here!
...
protected:
  void sink_it_(const details::log_msg& msg) override
  {
    ...
    succeeded = ::ReportEventW(event_log_handle(), eventlog::get_event_type(msg), eventlog::get_event_category(msg),
                               event_id_, current_user_sid_.as_sid(), 1, 0, &lp_wstr, nullptr);
#else
    LPCSTR lp_str = formatted.data();
    succeeded = ::ReportEventA(event_log_handle(), eventlog::get_event_type(msg), eventlog::get_event_category(msg),
