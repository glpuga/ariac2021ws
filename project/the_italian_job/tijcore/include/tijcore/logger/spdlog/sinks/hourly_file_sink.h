...
struct hourly_filename_calculator
{
  ...
  static filename_t calc_filename(const filename_t& filename, const tm& now_tm)
  {
    ...
    return fmt::format(SPDLOG_FILENAME_T("{}_{:04d}{:02d}{:02d}_{:02d}{}"), basename, now_tm.tm_year + 1900,
...
public:
  ...
  hourly_file_sink(filename_t base_filename, bool truncate = false, uint16_t max_files = 0)
    : base_filename_(std::move(base_filename)), truncate_(truncate), max_files_(max_files), filenames_q_()
  {
