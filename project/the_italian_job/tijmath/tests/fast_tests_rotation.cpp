...
{
  {
    ...
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitX, uut.rotationMatrix().row(0), tolerance_));
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitY, uut.rotationMatrix().row(1), tolerance_));
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitZ, uut.rotationMatrix().row(2), tolerance_));
  }
  {
    Rotation uut{ Matrix3{ Vector3::UnitZ, Vector3::UnitX, Vector3::UnitY } };
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitZ, uut.rotationMatrix().row(0), tolerance_));
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitX, uut.rotationMatrix().row(1), tolerance_));
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitY, uut.rotationMatrix().row(2), tolerance_));
  }
  {
    Rotation uut{ Matrix3{ Vector3::UnitY, Vector3::UnitZ, Vector3::UnitX } };
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitY, uut.rotationMatrix().row(0), tolerance_));
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitZ, uut.rotationMatrix().row(1), tolerance_));
    ASSERT_TRUE(areEqualWithinTolerance(Vector3::UnitX, uut.rotationMatrix().row(2), tolerance_));
  }
}
